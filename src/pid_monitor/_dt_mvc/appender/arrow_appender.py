...
from pid_monitor._dt_mvc.appender.typing import PandasDictBuffer, TableAppenderConfig


class ArrowTableAppender(PandasDictBuffer):
    ...
    def _write_hook(self, df: pd.DataFrame):
        record_batch = pa.record_batch(data=df)
